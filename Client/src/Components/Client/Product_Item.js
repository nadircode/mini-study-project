    ...
    <div class="container py-3">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div class="card"> <img class="card-img-top" src="https://c1.neweggimages.com/ProductImageCompressAll300/19-117-320-01.jpg" />
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-md-6 col-sm-10 offset-md-0 offset-sm-1 pt-md-0 pt-4">
                <div class="card"> <img class="card-img-top" src="https://c1.neweggimages.com/ProductImageCompressAll300/19-117-320-01.jpg" />
                    <div class="card-body">
                        <h6 class="font-weight-bold pt-1">Product title</h6>
                        <div class="text-muted description">Space for small product description</div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-10 offset-md-0 offset-sm-1 pt-lg-0 pt-4">
                <div class="card"> <img class="card-img-top" src="https://c1.neweggimages.com/ProductImageCompressAll300/19-117-320-01.jpg" />
                    <div class="card-body">
                        <h6 class="font-weight-bold pt-1">Product title</h6>
                        <div class="text-muted description">Space for small product description</div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-10 offset-md-0 offset-sm-1 pt-lg-4 pt-4">
                <div class="card"> <img class="card-img-top" src="https://c1.neweggimages.com/ProductImageCompressAll300/19-117-320-01.jpg"  />
                    <div class="card-body">
                        <h6 class="font-weight-bold pt-1">Product title</h6>
                        <div class="text-muted description">Space for small product description</div>
